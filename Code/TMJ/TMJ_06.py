...
cap3 = [[c.mon, c.mag], #3. Que Demais - Pág 40
        ...
        [c.ast, 'Traje de Batalha'],
        [c.ceb, c.mag, c.cas, c.franj, c.ast, 'Traje de Batalha'] + c.crowd(name='Robô Tzk'),
        [c.cas, c.franj, c.ast, 'Traje de Batalha'] + c.crowd(3),
        [c.ast, 'Traje de Batalha'] + c.crowd(3),
        [c.franj, c.ast, 'Traje de Batalha'] + c.crowd(3)[:5],
        [c.franj, c.ast, 'Traje de Batalha'] + c.crowd(3)[:5],
        [c.ast, 'Traje de Batalha'] + c.crowd(3),
        [c.ast, 'Traje de Batalha'] + c.crowd(3),
        [c.ceb, c.mag, c.cas, c.franj, c.ast, 'Traje de Batalha'],
        [c.mon, c.xab],
