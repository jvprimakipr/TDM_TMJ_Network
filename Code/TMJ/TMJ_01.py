...
cap2 = [[c.beg, c.franj, c.fal, c.ID('Robô Bem-Vindos'), c.ID('Entregador')], #2. O artefato místico - Pág 48
        ...
        [c.cap, c.fal, c.ID('Monstro de Poeira 1')],
        [c.cap, c.ID('Monstro de Poeira 1'), c.ID('Monstro de Poeira 2')],
        [c.franj, c.anj],
        [c.cap, 'Dragão de Poeira'],
        [c.anj, 'Dragão de Poeira'],
        [c.franj, c.fal, c.ID('Monstro de Poeira 1')],
        [c.franj, c.cap, c.fal, 'Monstro de Poeira 1'],
        [c.cap, c.fal],
        [c.cap],
        [c.franj, c.cap, c.fal, c.ID('Monstro de Poeira 1'), c.ID('Monstro de Poeira 2')],
        [c.franj, c.cap, c.fal, c.ID('Monstro de Poeira 1'), c.ID('Monstro de Poeira 2')],
        [c.mon, c.cas, c.lou],
        [c.mon, c.franj],
        [c.mon, c.ceb, c.franj],
        ...
        [c.mon, c.ceb, c.mag, c.franj, c.cap, c.ID('Monstro de Poeira 1')],
        [c.cas, c.cap],
        [c.mon, c.ceb, c.cap],
...
cap3 = [[c.beg, c.mon, c.ceb, c.mag, c.cas, c.yuk], #3 Poderosa Yuka - Pág 88
        ...
        [c.ceb, c.cap, c.franj, c.ebor, c.ezep, c.eeur, c.enot, c.ID('Monstro de Poeira 1')],
        [c.mon, c.ceb, c.mag, c.cas, c.cap],
        [c.mon, c.cap, c.yuk],
        ...
        [c.franj, c.fal, c.yuk, c.ID('Monstro de Poeira 1'), c.ID('Monstro de Poeira 2')],
