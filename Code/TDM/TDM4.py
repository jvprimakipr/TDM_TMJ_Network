...
pages4 = [[c.cas, c.ceb, c.mon, 'Duende', 'Múmia'], # capa
          [c.mon], # introdução
          [c.mon],
          [c.mon],
          ...
          ['Papai Noel', 'Rena 1', 'Rena 2', 'Rena 3', 'Duende', c.mon, c.ceb, c.cas],
          [c.cas],
          [c.cas, 'São Paulo', 'Anjinho'],
          [c.ceb, c.cas, c.mon],
          [c.min],
          [c.min, c.mag],
          [c.min, c.mag],
          ...
          [c.tv, c.blo],
          [c.tv, c.mtv, c.blo],
          [c.cas, c.ceb, 'Enxame de abelhas'],
          [c.chi, 'Galo', 'Cachorro', 'Lesma'],
          [c.chi, 'Tartaruga', 'Morcego', 'Formigas', 'Coruja'],
          [c.chi, 'Coelho', 'Macacos', 'Preguiça', 'Cavalo'], # dois macacos
          ['Pato', c.chi, 'Mula', 'Porco', 'Gatos'], # 3 filhotes de gato e a gata
          ['Bodes', c.chi, c.ros, 'Pássaros'], # dois bodes e dois pássaros
          [c.pit, 'Gronk'],
          [c.pit, 'Gronk'],
          [c.pit, 'Gronk'],
          [c.mon, c.ceb],
          ...
          [c.mon, c.ceb],
          [c.mon, c.ceb],
          [c.ceb]] # louco também? cebolinha vira o louco no último quadrinho
